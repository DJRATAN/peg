        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-24 gap-12">
          ...
          <div className="space-y-6 max-w-4xl">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-3 bg-[#004aad]/5 px-4 py-2 border border-[#004aad]/10"
            >
              <div className="w-2 h-2 bg-[#1B79EE] animate-pulse" />
              <p className="text-[#004aad] font-mono text-[10px] font-black uppercase tracking-[0.3em]">
                Target Demographic Infrastructure
              </p>
            </motion.div>
