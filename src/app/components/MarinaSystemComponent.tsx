    ...
    <section className="w-full min-h-screen bg-white py-24 px-10 md:px-20 relative overflow-hidden">
      ...
      <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-start relative z-10">
        ...
        <div className="lg:col-span-5 space-y-12">
          ...
          <div className="space-y-8 bg-slate-50 p-10 border-l-8 border-[#004aad]">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-8 h-full">
          ...
          <motion.div 
            whileHover={{ y: -10 }}
            className="md:col-span-2 relative aspect-video bg-[#004aad] overflow-hidden group border border-slate-200"
          >
            {/* Image Placeholder - Replace with your 3D Render of Marina */}
            <div className="absolute inset-0 bg-slate-800 opacity-40 mix-blend-multiply" />
            <div className="absolute inset-0 flex flex-col justify-end p-12 text-white">
              <div className="flex justify-between items-end">
                <div>
                  <h3 className="text-4xl font-black uppercase tracking-tighter">Monolithic Concrete Pontoons</h3>
                </div>
                <div className="p-4 rounded-full border border-white/20 group-hover:bg-[#1B79EE] group-hover:border-[#1B79EE] transition-all">
                  <ArrowUpRight className="w-6 h-6" />
                </div>
              </div>
            </div>
            {/* Decorative waves */}
            <Waves className="absolute top-10 right-10 w-32 h-32 text-white/5 opacity-20 rotate-12" />
          </motion.div>

          {/* Secondary Sub-Modules */}
          <div className="bg-white border-2 border-[#004aad] p-8 flex flex-col justify-between hover:bg-slate-50 transition-colors group">
             ...
             <p className="text-xs text-slate-400 mt-4 uppercase font-bold tracking-widest group-hover:text-[#1B79EE]">Deploy_Auto_Anchor</p>
          </div>
          ...
          <div className="bg-[#1B79EE] p-8 flex flex-col justify-between text-white hover:bg-[#004aad] transition-colors group">
             ...
             <p className="text-xs text-white/50 mt-4 uppercase font-bold tracking-widest group-hover:text-white">Scalable_Grid_Ready</p>
          </div>
